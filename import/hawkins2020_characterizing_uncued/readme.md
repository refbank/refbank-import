...
* one uses an ordering paradigm so doesn't have pre-marked divisions for what text goes with which target (imported here)
* one uses a matching paradigm (imported separately)
