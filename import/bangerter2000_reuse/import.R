...
target_labels <- read_csv(here("import/bangerter2000_reuse/raw_data/bangerter2000_combined.csv")) |>
  ...
  select(game_id, round_num = rep_num, trial_num, image_id)
...
transcripts <- read_csv(here("import/bangerter2000_reuse/raw_data/segmented_transcript.csv")) |>
  ...
  rename(target_image = image_id) |>
  select(game_id, player_id, role, text, message_irrelevant, message_num, round_num, trial_num, action_type, target_image)
...
combined <- transcripts |>
  mutate(
    ...
    short_cite = "Bangerter & Smolenski (2000)",
    group_size = 2,
    ...
    image_options = case_when(
      str_detect(target_image, "base") ~ "base_01;base_02;base_03;base_04;base_05;base_06;base_07;base_08",
      str_detect(target_image, "close") ~ "close_01;close_02;close_03;close_04;close_05;close_06;close_07;close_08",
      str_detect(target_image, "far") ~ "far_01;far_02;far_03;far_04;far_05;far_06;far_07;far_08"
    )
  )
