...
to_run <- c("yoon2019_audience", "wang2025_lvlms", "mankewitz2025_function","leung2024_scaffolding",
            "ji2025_adhoc", "hawkins2023_frompartners", "hawkins2021_respect", 
...
assert_that(max(trials$option_size) == 16) # change these as datasets change, but we're trying to rule out screw ups that make it like 96 or something absurd
